...
# Post-COVID Data Model: Data-Map 

The data map visualizes the identified Data sets of interest in the "Post-COVID Data Model" challenge associated with the data model designed by the Technologiestiftung Berlin and the Berlin 
Institute of Health at Charité Berlin.

The map can be viewed here: [post-covid-data-map.netlify.app](https://post-covid-data-map.netlify.app/)

Individual data points can be filtered using tags and clearly displayed in the list view. By clicking on a point, more 
information about the dataset can be accessed.
